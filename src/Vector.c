...
Node *NewNode(bool editable, pthread_t thread_id, size_t count, const lisp_object **array) {
...
const Vector *CreateVector(size_t count, lisp_object **entries) {
    ...
    Vector _ret = {{VECTOR_type, VectorCodegen, VectorToString, VectorCopy, NULL},
                   cnt,
                   LOG_NODE_SIZE,
                   EmptyNode,
                   {NULL}};
